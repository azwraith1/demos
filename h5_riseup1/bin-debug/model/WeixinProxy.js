 ...
 * @author wangtao
 *
 * Created at     : 2018-07-30 14:36:24
 * Last modified  : 2018-07-30 14:36:40
 */
...
(function (game) {
    var WeixinProxy = (function (_super) {
        ...
        function WeixinProxy() {
            var _this = _super.call(this, WeixinProxy.NAME) || this;
            _this.shareServerIndex = 0;
            _this.shareServerURLArr = [
                game.Constant.SERVER_PATH + 'share'
            ];
            return _this;
        }
        WeixinProxy.prototype.init = function () {
            this.config();
        };
        WeixinProxy.prototype.config = function () {
        ...
        WeixinProxy.prototype.share = function (url, desc) {
        ...
        WeixinProxy.prototype.changeShareText = function (desc) {
    ...
    __reflect(WeixinProxy.prototype, "game.WeixinProxy", ["puremvc.IProxy", "puremvc.INotifier"]);
})(game || (game = {}));
//# sourceMappingURL=WeixinProxy.js.map