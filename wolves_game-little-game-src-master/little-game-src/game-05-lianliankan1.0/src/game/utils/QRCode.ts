...
class QRCode {
    ...
    public setPosition(xPos: number, yPos: number, width: number, height: number) {
        ...
        if (document.body.clientWidth < document.body.clientHeight) {
            var wScale = document.body.clientWidth / GameConfig.curWidth();
            var hScale = document.body.clientHeight / GameConfig.curHeight();
            ...
            var wScale = document.body.clientWidth / GameConfig.curHeight();
            var hScale = document.body.clientHeight / GameConfig.curWidth();
            this.htmlCode.style.width = height * wScale + "px";
            this.htmlCode.style.height = width * hScale + "px";
            this.htmlCode.style.top = (GameConfig.curWidth() - xPos - width) * hScale + "px";
